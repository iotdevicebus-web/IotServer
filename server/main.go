...
func main() {
	...
	// システム総合仕様書 & 取扱説明書 & プロトコル仕様書 & STM32説明書 & ESP32説明書 & 画像ファイル配信
	...
	webMux.HandleFunc("/esp32", func(w http.ResponseWriter, r *http.Request) {
		http.ServeFile(w, r, "../docs/edge_user_guide_esp32.html")
	})
